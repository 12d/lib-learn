...
/**
 ...
 2010-08-16  Kael:
 TODO:
 鈭� GLOBAL: remove all native implements of non-ECMAScript5 standards
...
(function () {
    ...
    function parser(rawMatch, separator, combinator, combinatorChildren, tagName, id, className, attributeKey, attributeOperator, attributeQuote, attributeValue, pseudoClass, pseudoQuote, pseudoClassValue) {
...
/**
 ...
 TODO:
 鈭� A. deal with getter and setter of boolean attributes
...
// no operation
    ...
    function _define(name, path, dependencies, factory, uri) {
        ...
        // <code:pseudo>
        //         DP.define('http://myurl', function(){鈥);
        // </code>
...
(function (D) {
    ...
    //configures
        ...
        netSpeedSampleRate = 0.1, //娴嬬綉閫熺殑閲囨牱鐜�
    // downloadFileURL = 'http://1.ispeed.sinaapp.com/test381.zip', //娴嬭瘯鐩爣鏂囦欢
    // swfFileURL = 'http://1.ispeed.sinaapp.com/SpeedTest.swf', //娴嬭瘯鐢ㄧ殑鏍稿績鏂囦欢
    ...
    // METHOD_KEY = '__hmet',  // 浠ｇ爜涓湭鍙戠幇浣跨敤
    // ARGS_KEY = '__harg',
    //ATTACH_KEY = '__had',
    ...
    // PAGE_ID_KEY = '__ppp',
         ...
         * optimized for v8
         * @param obj {Object} 闇€瑕佸瓧绗︿覆鍖栫殑瀵硅薄
         * @returns {String}
         */
            stringify = (function () {
        ...
        /**
         * 鐢熸垚hippo涓撶敤鐨剄uery string
         * @param key {String}
         * @param value {String || Array}
         */
            generateQuery = (function () {
            // 鏈変簺鍐呭鏄崟娆′細璇濅繚鎸佷笉鍙樼殑锛屽厛璁＄畻鍑烘潵
            var h, w, s, c, f,
    ...
    mix(hippo, {
         ...
         * @param maintainExtData {Boolean}(optional) 鏄惁淇濈暀閫氳繃 ext 鏂规硶娣诲姞鐨勬暟鎹紝榛樿涓轰笉淇濈暀
         */
